...
Feature.find_or_initialize_by(id: 10, feature_type: "FAQ for User") do |f|
  f.save!
end
Feature.find_or_initialize_by(id: 11, feature_type: "FAQ for CustomerManager") do |f|
  f.save!
end
Feature.find_or_initialize_by(id: 12, feature_type: "FAQ for ProjectManager") do |f|
  f.save!
end