...
ActiveRecord::Schema.define(version: 20180403112918) do
  ...
  create_table "customers_holidays", id: false, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
  ...
  create_table "shared_employees", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer  "user_id"
    t.integer  "customer_id"
  ...
  create_table "upload_timesheets", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer  "week_id"
    t.string   "time_sheet"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "user_roles", id: false, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "user_id", null: false
    t.integer "role_id", null: false
    t.index ["user_id", "role_id"], name: "index_user_roles_on_user_id_and_role_id", using: :btree
  end

  create_table "user_week_statuses", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer  "status_id"
    t.integer  "week_id"
    t.integer  "user_id"
    t.datetime "created_at", null: false
