...
# role :web, '184.178.49.37'                          # Your HTTP server, Apache/etc
# role :app, '184.178.49.37'                          # This may be the same as your `Web` server
# role :db,  '184.178.49.37', :primary => true # This is where Rails migrations will run
